  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row mt-3">
		...
		$filename1=$row1['adharphoto'];
		$licence=$row1['licenceno'];
						...
						<td>
						  <img src="image/<?php echo $profilephoto; ?>"style="width:70% ;height:70%;">
                         </td>
					      <td>
                           <?php echo $email; ?>
                       </td>
						  ...
						  <td>
						  <img src="image/<?php echo $filename1; ?>"style="width:100% ;height:100%;">
                         </td>
						  <td>
                         <?php echo $licence; ?>
                         </td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from worker where id='".$selectano."'";
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script> location.href='viewworker.php'; </script>";
}
?>
            </div>
            </div>
