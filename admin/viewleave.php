    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Leave note</h5>
              ...
              <table class="table">
				...
				<?php
					include 'config.php';
					$sql1 = "select * from leavenote order by id desc";
                  ...
                  <tr align="center">
					...
					<button type="submit" name="accept" class="btn btn-warning btn-round px-2">Accept</button>
					<button type="submit" name="reject" class="btn btn-danger btn-round px-2">Reject</button>
					</form>
					<?php } else if($status!='') {?>
                ...
                <?php
					...
					$query1 = "update leavenote set status='Accepted' where id='".$id."'";
					...
					$query1 = "update leavenote set status='Rejected' where id='".$id."'";
					mysqli_query($con,$query1) or die(mysqli_error($con));
