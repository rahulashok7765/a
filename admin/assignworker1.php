...
if(isset($_GET['ass']))
{
	$assign=$_GET['ass'];
	include 'config.php';
	$sql1 = "select * from location where id='".$assign."'";
...
if(isset($_POST['submit']))
{
	...
	$query = "INSERT INTO assign1 (wname,bookid,date)VALUES('".$wname."','".$assign."','".$date."')";
	   
	if(mysqli_query($con,$query))
	{
	$query1 = "update location set status='assign' where id='".$assign."'";
