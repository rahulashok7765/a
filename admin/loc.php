  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
	   ...
	   <li>
        <a href="assignworker.php">
          <i class="zmdi zmdi-invert-colors"></i> <span>Assign Workers</span>
        </a>
      </li>
	   <li>
      ...
      <div class="col-lg-12">
         <div class="card" style="align-items:normal";>
		   ...
		   <div class="form-group">
            <label for="input-3">Location Name</label>
            <input type="text"  name="location"class="form-control" id="input-3" placeholder="Enter location name">
           </div>
           <div class="form-group">
            <label for="input-2">Adress</label>
            <input type="text" name="address"class="form-control" id="input-2" placeholder="Enter Address">
           </div>
           <div class="form-group">
            <label for="input-3">Map Link</label>
            <input type="url" name="url" class="form-control" id="input-3" placeholder="Enter Map ">
           </div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO location(location,address,url)VALUES('".$location."','".$address."','".$url."')";
		...
		echo "<script>
			...
			echo "<script> location.href='loc.php'; </script>";
