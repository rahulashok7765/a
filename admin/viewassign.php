      ...
      <div class="row mt-3">
        <div class="col-lg-12">
          <div class="card" style="align-items:normal";>
            <div class="card-body">
              <h5 class="card-title">Assign Work Table (User Booking)</h5>
...
?>
		...
		<div class="col-lg-12">
          <div class="card" style="align-items:normal";>
            <div class="card-body">
              <h5 class="card-title">Assign Work Table (External Booking)</h5>
			  <div class="table-responsive">
              <table class="table table-bordered">
                <thead>
                  <tr>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from assign1 where id='".$selectano."'";;
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script> location.href='viewassign.php'; </script>";
}
?>
