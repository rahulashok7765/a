  ...
  <div class="content-wrapper">
    <div class="container-fluid">
		...
		if(isset($_GET['lid']))
		{
			...
			include 'config.php';
			$sql1 = "select * from leavenote where id='".$lid."'";
        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            <div class="card-img-block">
                <img class="img-fluid" src="bg.jpg" alt="Card image cap">
            </div>
            <div class="card-body pt-5">
                <img src="pr.png" alt="profile-image" class="profile">
                <h5 class="card-title" style="color:yellow"><?php echo $wid;?></h5>
                <p class="card-text">Date:<?php echo $date;?>.</p>
                <p class="card-text">Subject:<?php echo $subject;?>.</p>
                <p class="card-text">Message:<?php echo $message;?>.</p>
                <p class="card-text">Status:<b style="color:yellow"><?php echo $status;?>.</b></p>
