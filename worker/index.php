...
<head>
  ...
  <title>Ashok Water Supply- Worker Login</title>
  <!-- loader-->
	...
	<div class="card card-authentication1 mx-auto my-5">
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Ashok Water supply Worker</div>
			...
			<div class="form-group">
            <button type="submit" name="login" class="btn btn-light btn-round px-5">Login</button>
          </div>
