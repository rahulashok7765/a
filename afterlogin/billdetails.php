                        ...
                        <div class="row align-items-center">
							...
							<table id="customers" style="background-color:white;">
							  ...
							  <?php
								include("config.php");
								$status='confirm';
								$sql = "SELECT bno, name, phone, date, paystatus from bill where phone='".$phone."' and status='".$status."' group by bno";
								...
								if($count>0)
								{
									...
									<tr align="center">
										...
										<td>
										<?php if($paystatus=='') { ?>
										<a href="paidpay.php?bill=<?php echo $bno; ?>" class="btn btn-success btn-round">Pay</a>
